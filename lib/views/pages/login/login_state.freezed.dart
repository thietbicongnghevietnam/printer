...
mixin _$LoginState {
  ...
  bool get newVersion => throw _privateConstructorUsedError;
...
class _$LoginStateImpl implements _LoginState {
  ...
  @override
  String toString() {
    return 'LoginState(pageStatus: $pageStatus, processing: $processing, errorEntity: $errorEntity, username: $username, version: $version, newVersion: $newVersion)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, pageStatus, processing,
      errorEntity, username, version, newVersion);
...
abstract class _LoginState implements LoginState {
  factory _LoginState(
      ...
      final String username,
      final String version,
      final bool newVersion}) = _$LoginStateImpl;
