...
part of 'open_good_receipt_state.dart';
...
mixin _$OpenGoodReceiptState {
  ...
  @JsonKey(ignore: true)
  $OpenGoodReceiptStateCopyWith<OpenGoodReceiptState> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $OpenGoodReceiptStateCopyWith<$Res> {
  factory $OpenGoodReceiptStateCopyWith(OpenGoodReceiptState value,
          $Res Function(OpenGoodReceiptState) then) =
      _$OpenGoodReceiptStateCopyWithImpl<$Res, OpenGoodReceiptState>;
  @useResult
  $Res call(
...
/// @nodoc
class _$OpenGoodReceiptStateCopyWithImpl<$Res,
        $Val extends OpenGoodReceiptState>
    implements $OpenGoodReceiptStateCopyWith<$Res> {
  _$OpenGoodReceiptStateCopyWithImpl(this._value, this._then);
    ...
    return _then(_value.copyWith(
      ...
      receivingCard: freezed == receivingCard
          ...
          : receivingCard // ignore: cast_nullable_to_non_nullable
              as ReceivingCard?,
      materialInfo: freezed == materialInfo
          ? _value.materialInfo
...
/// @nodoc
abstract class _$$OpenGoodReceiptStateImplCopyWith<$Res>
    implements $OpenGoodReceiptStateCopyWith<$Res> {
  factory _$$OpenGoodReceiptStateImplCopyWith(_$OpenGoodReceiptStateImpl value,
          $Res Function(_$OpenGoodReceiptStateImpl) then) =
      __$$OpenGoodReceiptStateImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {PageStatus pageStatus,
...
/// @nodoc
class __$$OpenGoodReceiptStateImplCopyWithImpl<$Res>
    extends _$OpenGoodReceiptStateCopyWithImpl<$Res, _$OpenGoodReceiptStateImpl>
    implements _$$OpenGoodReceiptStateImplCopyWith<$Res> {
  __$$OpenGoodReceiptStateImplCopyWithImpl(_$OpenGoodReceiptStateImpl _value,
      $Res Function(_$OpenGoodReceiptStateImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$OpenGoodReceiptStateImpl(
      pageStatus: null == pageStatus
          ? _value.pageStatus
          : pageStatus // ignore: cast_nullable_to_non_nullable
              as PageStatus,
...
class _$OpenGoodReceiptStateImpl implements _OpenGoodReceiptState {
  _$OpenGoodReceiptStateImpl(
  ...
  @override
  String toString() {
    return 'OpenGoodReceiptState(pageStatus: $pageStatus, processing: $processing, errorEntity: $errorEntity, receivingCard: $receivingCard, materialInfo: $materialInfo, printerDevices: $printerDevices, selectedPrinterDevice: $selectedPrinterDevice)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$OpenGoodReceiptStateImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$OpenGoodReceiptStateImplCopyWith<_$OpenGoodReceiptStateImpl>
      get copyWith =>
          __$$OpenGoodReceiptStateImplCopyWithImpl<_$OpenGoodReceiptStateImpl>(
              this, _$identity);
}

abstract class _OpenGoodReceiptState implements OpenGoodReceiptState {
  factory _OpenGoodReceiptState(
      {final PageStatus pageStatus,
      final bool processing,
      final ErrorEntity? errorEntity,
      final ReceivingCard? receivingCard,
      ...
      final PrinterDevice? selectedPrinterDevice}) = _$OpenGoodReceiptStateImpl;
