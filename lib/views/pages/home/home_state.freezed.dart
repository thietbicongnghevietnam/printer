...
class _$HomeStateImpl implements _HomeState {
  ...
  @override
  String toString() {
    return 'HomeState(pageStatus: $pageStatus, processing: $processing, errorEntity: $errorEntity, roles: $roles, userId: $userId)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, pageStatus, processing,
      errorEntity, const DeepCollectionEquality().hash(_roles), userId);
...
abstract class _HomeState implements HomeState {
  factory _HomeState(
      ...
      final String userId}) = _$HomeStateImpl;
