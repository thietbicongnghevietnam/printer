...
class EmapKittingRectangle extends IEmapKitting {
  EmapKittingRectangle(super.param);
  ...
  void build() {
    ...
    canvas.save();
    canvas.translate(
        (param.parentPosition?.dx ?? 0), (param.parentPosition?.dy ?? 0));

    final backgroundPaint = Paint()..color = widget.fill.toString().toColor();
    final borderPaint = Paint()
      ..style = PaintingStyle.stroke
      ..color = widget.border.toColor()
