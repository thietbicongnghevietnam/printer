...
part 'storage_jupiter_state.freezed.dart';

@freezed
class StorageJupiterState extends BaseState with _$StorageJupiterState {
  factory StorageJupiterState({
